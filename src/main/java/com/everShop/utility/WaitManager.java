...
public class WaitManager {
    ...
    public static void waitForElementToBeClickable(WebDriver wd, By elementToBeClickable) {
        FluentWait wait = new FluentWait(wd);
        wait.withTimeout(Duration.ofSeconds(10))
                .pollingEvery(Duration.ofSeconds(1))
    ...
    public static void waitForElementToHaveAtrributeWithSpecificValue(WebDriver wd, WebElement webElementToLocate, String attributeName, String attributeValue) {
        FluentWait wait = new FluentWait(wd);
